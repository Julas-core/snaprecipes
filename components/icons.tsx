...
// Using icons from the lucide-react library for consistency and correctness.
...
// Replaced the previous icon (which was `ImageOff`) with `Wand2` for "Generate Recipe".
...
// Replaced with Lucide's `ChefHat` icon for Kitchen Mode.
...
// Corrected malformed `CameraOffIcon` with the standard Lucide version.
