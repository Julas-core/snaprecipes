        ...
        <div className="flex gap-4 px-2" style={{ minWidth: 'min-content' }}>
          {recipes.map((recipe) => (
            <div
              ...
              className="relative flex-shrink-0 w-80 sm:w-96 aspect-video bg-amber-200 rounded-xl shadow-lg overflow-hidden group cursor-pointer hover:shadow-xl transition-all hover:scale-[1.01]"
            >
              {/* Image Background */}
              {recipe.imageUrl ? (
